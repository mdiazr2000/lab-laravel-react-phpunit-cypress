...
$fixers = [
    ...
    'phpdoc_trim'                                 => true,
    'phpdoc_var_without_name'                     => false, // disabled as this breaks linting in PHPStorm
    'self_accessor'                               => true,
    'simplified_null_return'                      => false, // disabled as risky because functions where the response is used
...
$finder = Finder::create()->in(__DIR__)
    ->exclude(['public', 'vendor', 'storage', 'bootstrap', 'nova'])
